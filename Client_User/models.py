...
# Create your models here.
import uuid
from Client_User.interface import Entity
...
class Client(Entity, models.Model):
    ...
    def display_info(self):
        return f"Client Name: {self.name}, Postal Code: {self.postal_code}"
    def __str__(self):
        return self.name
...
class Vet(Entity, models.Model):
    ...
    def display_info(self):
        return f"Vet Name: {self.name}, Postal Code: {self.postal_code}, Phone: {self.phone}"
#QUICK SEPARATION
    def __str__(self):
        return self.name
